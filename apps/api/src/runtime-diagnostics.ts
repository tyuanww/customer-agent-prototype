export const API_RUNTIME_DIAGNOSTIC_CODES = Object.freeze([
  'ANNOUNCE_FAILED',
  'ANNOUNCE_CONNECT_FAILED',
  'ANNOUNCE_AUDIT_CONNECT_FAILED',
  'ANNOUNCE_AUDIT_BEGIN_FAILED',
  'ANNOUNCE_AUDIT_WRITE_FAILED',
  'ANNOUNCE_AUDIT_COMMIT_FAILED',
  'ANNOUNCE_AUDIT_ROLLBACK_FAILED',
  'API_REQUEST_FAILED',
